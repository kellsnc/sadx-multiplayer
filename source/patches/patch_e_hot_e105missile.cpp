...
FastFunctionHookPtr<decltype(&EnemyHotTgtMissile_exec_r)> EnemyHotTgtMissile_exec_h(0x5ACB70);
...
static void __cdecl EnemyHotTgtMissile_exec_r(task* tp)
{
	if (multiplayer::IsActive())
	{
		...
		EnemyHotTgtMissile_exec_h.Original(tp);
		playertwp[0] = pltwp;
	}
	else
	{
...
{
	EnemyHotTgtMissile_exec_h.Hook(EnemyHotTgtMissile_exec_r);
}
