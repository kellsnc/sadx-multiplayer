...
FastUsercallHookPtr<void(*)(task* tp), noret, rEDI> SetupCamPathCam2_Casino_h(0x5C32D0);
...
static void SetupCamPathCam2_Casino_r(task* tp)
{
	if (multiplayer::IsEnabled())
	{
		SetupCamPathCam2_Casino_h.Original(tp);
		...
		for (int i = 1; i < PLAYER_MAX; ++i)
		{
			...
			SetupCamPathCam2_Casino_h.Original(tp2);
